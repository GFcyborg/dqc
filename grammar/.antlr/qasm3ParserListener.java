...
public interface qasm3ParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link qasm3Parser#nopStatement}.
	 * @param ctx the parse tree
	 */
	void enterNopStatement(qasm3Parser.NopStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link qasm3Parser#nopStatement}.
	 * @param ctx the parse tree
	 */
	void exitNopStatement(qasm3Parser.NopStatementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link qasm3Parser#quantumCallExpression}.
	 * @param ctx the parse tree
	 */
	void enterQuantumCallExpression(qasm3Parser.QuantumCallExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link qasm3Parser#quantumCallExpression}.
	 * @param ctx the parse tree
	 */
	void exitQuantumCallExpression(qasm3Parser.QuantumCallExpressionContext ctx);
	/**
