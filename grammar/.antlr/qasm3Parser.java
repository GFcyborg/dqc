...
public class qasm3Parser extends Parser {
	...
	public static class NopStatementContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof qasm3ParserListener ) ((qasm3ParserListener)listener).enterNopStatement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof qasm3ParserListener ) ((qasm3ParserListener)listener).exitNopStatement(this);
		}
	}
	...
	public static class QuantumCallExpressionContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof qasm3ParserListener ) ((qasm3ParserListener)listener).enterQuantumCallExpression(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof qasm3ParserListener ) ((qasm3ParserListener)listener).exitQuantumCallExpression(this);
		}
	}
