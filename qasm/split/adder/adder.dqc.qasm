...
if(telept_Zcorrect_a0_1) z a0_TO2;
if(telept_Xcorrect_a0_1) x a0_TO2;
// a[0] teleported into a0_TO2
qubit a1_epr_1;
qubit a1_TO2;
...
if(telept_Zcorrect_a1_1) z a1_TO2;
if(telept_Xcorrect_a1_1) x a1_TO2;
// a[1] teleported into a1_TO2
qubit a2_epr_1;
qubit a2_TO2;
...
if(telept_Zcorrect_a2_1) z a2_TO2;
if(telept_Xcorrect_a2_1) x a2_TO2;
// a[2] teleported into a2_TO2
qubit a3_epr_1;
qubit a3_TO2;
...
if(telept_Zcorrect_b1_1) z b1_TO2;
if(telept_Xcorrect_b1_1) x b1_TO2;
// b[1] teleported into b1_TO2
qubit b2_epr_1;
qubit b2_TO2;
...
if(telept_Zcorrect_b2_1) z b2_TO2;
if(telept_Xcorrect_b2_1) x b2_TO2;
// b[2] teleported into b2_TO2
qubit b3_epr_1;
qubit b3_TO2;
